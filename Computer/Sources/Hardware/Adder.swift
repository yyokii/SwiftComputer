...
struct Adder15 {
    static func add(a: Bit15, b: Bit15) -> Bit15 {
        ...
        return Bit15((add1.sum, add2.sum, add3.sum, add4.sum, add5.sum, add6.sum, add7.sum, add8.sum, add9.sum, add10.sum, add11.sum, add12.sum, add13.sum, add14.sum, add15.sum))
    }
    
    static func inc(a: Bit15) -> Bit15 {
        add(a: a, b: Bit15.one)
    }
}
